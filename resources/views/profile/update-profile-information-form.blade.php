        ...
        <div style="margin-top: -45px">
            ...
            <div class="card-body" style="margin-top: -30px">
                <div class="d-flex align-items-start align-items-sm-center gap-4">
                    <img src="{{ $this->user->profile_photo_url }}" alt="{{ $this->user->name }} class=" d-block
                        rounded" height="100" width="100" id="uploadedAvatar" />
            ...
            <div class="card-body" style="margin-top: -20px">
                ...
                <div class="mt-2">
                    <button type="submit" class="btn btn-primary me-2" wire:loading.attr="disabled" wire:target="photo">Save changes</button>

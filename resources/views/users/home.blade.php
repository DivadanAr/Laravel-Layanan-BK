...
<body>
        ...
        <div class="left-side">
            ...
            <div class="tips">
                <div class="tips-box">
                    ...
                    <p>Seek social support: Connect with friends, family, or support groups. Share your feelings and concerns with trusted individuals who can provide a listening ear and offer support. </p>
                </div>
    ...
    <div class="about" id="about">
            ...
            <div class="first-row-right">
                ...
                <div class="first-row-right-bottom">
                    ...
                    <div class="visi">
                        ...
                        <p class="visi-desk">
                            The vision of our counseling services is the realization of a happy human life through the availability of assistance services in providing developmental support and problem solving so that students develop optimally, independently and happily.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="second-row">
            <div class="misi">
                ...
                <p class="misi-desk">
                    The primary mission of counseling guidance is to provide assistance and understanding to individuals or groups in overcoming the problems they face. This involves listening with empathy, understanding their situation, and providing relevant and useful advice.
                </p>
            </div>
            <div class="ones">
                <p>Kegiatan Sosial</p>
    ...
    <footer>
        ...
        <p class="footer-desk">Lorem ipsum dolor sit amet consectetur. Ornare felis viverra orci nisi. Lorem ipsum dolor sit amet consectetur. Ornare felis viverra orci nisi. Lorem ipsum dolor sit amet consectetur. Ornare felis viverra orci nisi. </p>
        <ul>
            <li><a href="">Home</a></li>
